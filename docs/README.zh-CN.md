...
| | |
|---|---|
| ![卡片详情](assets/screenshots/zh-CN/02-card-detail.png) | 卡片详情：blocker、artifact、三态 task、可恢复的 session |
| ![tips 气泡](assets/screenshots/zh-CN/03-tips-bubble.png) | 走来走去的像素小猫 + 滚动 tips 气泡(拖动定位,点击切换) |
| ![周报](assets/screenshots/zh-CN/04-weekly-modal.png) | 自动生成的周报(周五 12:00 触发) |
